...
public class MegaRequest {
  ...
  public final static int TYPE_REMOVE_CONTACT = TYPE_RETRY_PENDING_CONNECTIONS + 1;
  ...
  public final static int TYPE_GET_RECOVERY_LINK = TYPE_SET_PROXY + 1;
  public final static int TYPE_QUERY_RECOVERY_LINK = TYPE_GET_RECOVERY_LINK + 1;
  public final static int TYPE_CONFIRM_RECOVERY_LINK = TYPE_QUERY_RECOVERY_LINK + 1;
  public final static int TYPE_GET_CANCEL_LINK = TYPE_CONFIRM_RECOVERY_LINK + 1;
  public final static int TYPE_CONFIRM_CANCEL_LINK = TYPE_GET_CANCEL_LINK + 1;
  public final static int TYPE_GET_CHANGE_EMAIL_LINK = TYPE_CONFIRM_CANCEL_LINK + 1;
  public final static int TYPE_CONFIRM_CHANGE_EMAIL_LINK = TYPE_GET_CHANGE_EMAIL_LINK + 1;
  public final static int TYPE_CHAT_UPDATE_PERMISSIONS = TYPE_CONFIRM_CHANGE_EMAIL_LINK + 1;
  public final static int TYPE_CHAT_TRUNCATE = TYPE_CHAT_UPDATE_PERMISSIONS + 1;
  public final static int TYPE_CHAT_SET_TITLE = TYPE_CHAT_TRUNCATE + 1;
  public final static int TYPE_SET_MAX_CONNECTIONS = TYPE_CHAT_SET_TITLE + 1;
  public final static int TYPE_PAUSE_TRANSFER = TYPE_SET_MAX_CONNECTIONS + 1;
  public final static int TYPE_MOVE_TRANSFER = TYPE_PAUSE_TRANSFER + 1;
  public final static int TYPE_CHAT_PRESENCE_URL = TYPE_MOVE_TRANSFER + 1;
  public final static int TYPE_REGISTER_PUSH_NOTIFICATION = TYPE_CHAT_PRESENCE_URL + 1;
  public final static int TYPE_GET_USER_EMAIL = TYPE_REGISTER_PUSH_NOTIFICATION + 1;
  public final static int TYPE_APP_VERSION = TYPE_GET_USER_EMAIL + 1;
  public final static int TYPE_GET_LOCAL_SSL_CERT = TYPE_APP_VERSION + 1;
  public final static int TYPE_SEND_SIGNUP_LINK = TYPE_GET_LOCAL_SSL_CERT + 1;
  public final static int TYPE_QUERY_DNS = TYPE_SEND_SIGNUP_LINK + 1;
  public final static int TYPE_QUERY_GELB = TYPE_QUERY_DNS + 1;
  public final static int TYPE_CHAT_STATS = TYPE_QUERY_GELB + 1;
  public final static int TYPE_DOWNLOAD_FILE = TYPE_CHAT_STATS + 1;
  public final static int TYPE_QUERY_TRANSFER_QUOTA = TYPE_DOWNLOAD_FILE + 1;
  public final static int TYPE_PASSWORD_LINK = TYPE_QUERY_TRANSFER_QUOTA + 1;
  public final static int TYPE_GET_ACHIEVEMENTS = TYPE_PASSWORD_LINK + 1;
  public final static int TYPE_RESTORE = TYPE_GET_ACHIEVEMENTS + 1;
  public final static int TYPE_REMOVE_VERSIONS = TYPE_RESTORE + 1;
  public final static int TOTAL_OF_REQUEST_TYPES = TYPE_REMOVE_VERSIONS + 1;
