...
/* Define to use FreeImage as a static library. */
/* #undef FREEIMAGE_LIB */

/* Define to indicate AIO presence in librt */
#define HAVE_AIO_RT 1
...
/* #undef HAVE_MEDIAINFO_MEDIAINFO_H */
...
#define PACKAGE_STRING "libmega 3.3.0"
