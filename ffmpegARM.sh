...
#git clone https://github.com/magiclen/FFmpeg-For-MagicLen-Applications.git ffmpeg
cd ffmpeg
...
cd ../../../
#echo $(pwd)
./configure --prefix=$PREFIX --disable-shared --enable-libx265 --enable-gpl --enable-static --disable-doc --enable-ffmpeg --disable-ffplay --disable-ffprobe --enable-avdevice --disable-doc --disable-symver --cross-prefix=$TOOLCHAIN/bin/arm-linux-androideabi- --target-os=linux --arch=armv7 --enable-cross-compile --sysroot=$SYSROOT --extra-cflags="-Os -fPIE $ADDI_CFLAGS" --extra-ldflags="-pie $ADDI_LDFLAGS" $ADDITIONAL_CONFIGURE_FLAG
